...
from knowledge_guided_symbolic_alpha.dataio.route_b_normalize import normalize_xsc_route_b


def test_normalize_xsc_route_b_creates_expected_raw_files(tmp_path: Path) -> None:
    ...
    output_root = tmp_path / "route_b" / "wrds"
    summary = normalize_xsc_route_b(source_root=source_root, output_root=output_root, chunksize=2)
