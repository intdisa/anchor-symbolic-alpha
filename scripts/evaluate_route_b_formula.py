...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a Route B formula on processed split parquets.")
    parser.add_argument("--formula", required=True)
    parser.add_argument("--subset-config", default="configs/route_b_subset.yaml")
