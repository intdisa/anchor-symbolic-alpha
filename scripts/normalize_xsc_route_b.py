...
from knowledge_guided_symbolic_alpha.dataio.route_b_normalize import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Normalize local xsc Route B files into the standard raw layout.")
    parser.add_argument("--source-root", default=DEFAULT_XSC_SOURCE_ROOT.as_posix())
    parser.add_argument("--output-root", default=DEFAULT_ROUTE_B_WRDS_ROOT.as_posix())
