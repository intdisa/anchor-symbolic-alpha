...
financial data. The current mainline is a U.S. equities cross-sectional
anchor-agent system, not a multi-agent synergy system. The working thesis is:
...
- default runs now execute the anchor agent only; challenger families are opt-in verification branches
...
.venv/bin/python experiments/run_anchor_train.py --episodes 3
...
## U.S. equities bootstrap

The mainline targets a U.S. equities cross-sectional panel backed by WRDS.
The repository now includes:

- `configs/us_equities_data.yaml`
